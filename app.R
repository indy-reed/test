...
ui <- page_sidebar(
  ...
  layout_columns(
    card(card_header("Conversions over time"), plotOutput("line")),
    card(card_header("Conversion rates"), plotOutput("bar")),
    value_box(
    ...
    card(card_header("Conversion rates by subgroup"), tableOutput("table")),
